...
def topology():
    ...
    # filename2 = "/media/psf/Home/Documents/GitHub/mininet-wifi-project/Stackelberg/Log/msg.txt"
    # f2 = open(filename2,'r')
    ...
    #             thread.start_new_thread(command,(h1,"python send.py 10.0.0.1 h1-eth0 10.0.0.2 %d" % num))
    #         except:
    #             print("send error")
    #         time.sleep(18) # wait thread finish
    #         print("send finish")
    #         #filename3 = "/home/shlled/mininet-wifi/Log/final.txt"
    #         filename3 = "/media/psf/Home/Documents/GitHub/mininet-wifi-project/Stackelberg/Log/final.txt"
    #         f3 = open(filename3,'r')
